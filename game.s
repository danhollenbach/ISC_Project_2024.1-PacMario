...
SETUP:		li s10, 0			# contador para a animacao do sprite
		...
		add s9, s9, t1			# soma ao contador de pontos a pontuacao pre-existente
		#############			# carrega o endereco do mapa2 em a0
		j PRINT_MAP
...
GAME_LOOP: 	la a0, POINTS
		lh a0, 0(t0)			# carrega o número de pontos em a0
		li t0, 244			# numero total de pontos por fase
		...
		beqz t0, STAGE_1
		#########			# carrega o 2 mapa de colisao das moedas
		#########			# verifica colisao de moedas no segundo mapa
		j STEP_2
...
NEXT_LEVEL:	li a7, 32
		...
		mv t1, s9			# guarda a soma atual de pontos
		la a0, STAGE
		lh t2, 0(a0)
...
.data
	...
	.include "Sprites_data/moedas_1.data"
